                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <div style="margin: auto;padding: 1.4rem;background-color: white;border-radius: 8px;">
                                                                    ...
                                                                    <div>Dear <strong>{{ $name }}</strong>, 
                                                                        <br>
                                                                        <span>This letter is to inform you that we received your application for <strong>Web Developer</strong>. We appreciate you taking the time to apply.</span>
                                                                    </div>

                                                                    <div style="object-fit:contain;">
                                                                        <img src="https://asset.cpbangladesh.com/documents/received_email_20220111113648y0UkfvWRsW.png" alt="image"
