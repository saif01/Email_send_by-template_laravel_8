                                                            ...
                                                            <div>
                                                                <div style="margin: auto;padding: 1.4rem;background-color: white;border-radius: 8px;">
                                                                    ...
                                                                    <div>Hi <strong>{{ $name }}</strong>, 
                                                                        <br>
                                                                        <span>Your registered email-id is <strong>abc@gmail.com</strong></span>
                                                                    </div>

                                                                    <div style="object-fit:contain;">
                                                                        <img src="https://imgdb.net/storage/uploads/844841de27daec2c0ad14d12c1451b91b0cfe40401d9629110e0d4bb456c1d06.png" alt="image"
                                                                    ...
                                                                    <div style="margin: 1rem 0;text-align:center;">
                                                                        <a href="https://www.facebook.com" class="button_div" style="padding:0.7rem 1.8rem;background-color: red;border-radius: 3px;color: white;text-decoration: none;">Reset Password</a>
                                                                    </div>
